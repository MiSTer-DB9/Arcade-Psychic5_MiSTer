...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-Psychic5_MiSTer.git"
CORE_NAME=(Arcade-Psychic5)
...
UPSTREAM_CORE_NAME=(Arcade-Psychic5)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-Psychic5.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-Psychic5.rbf)
